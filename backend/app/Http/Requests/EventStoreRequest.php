...
class EventStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'event_meta.telemovel_noivo_2' => ['nullable', 'string', 'max:255'],
            'event_meta.telemovel_noiva_2' => ['nullable', 'string', 'max:255'],
            'event_meta.facebook' => ['nullable', 'string', 'max:255'],
            ...
            'event_meta.residencia_apos_casamento' => ['nullable', 'string', 'max:500'],
            ...
            'event_meta.padrinhos_raw' => ['nullable', 'string', 'max:500'],
            ...
            'event_meta.telemovel_mae' => ['nullable', 'string', 'max:255'],
            'event_meta.telemovel_pai' => ['nullable', 'string', 'max:255'],
            'event_meta.email_pais' => ['nullable', 'string', 'max:255'],
            'event_meta.morada' => ['nullable', 'string', 'max:500'],
            'event_meta.pais_bebe_raw' => ['nullable', 'string', 'max:500'],
            'event_meta.avos_maternos' => ['nullable', 'string', 'max:500'],
            'event_meta.avos_paternos' => ['nullable', 'string', 'max:500'],
            'event_meta.nome_livre' => ['nullable', 'string', 'max:255'],
            ...
            'event_meta.mesa_apoio_fotografos' => ['nullable', 'string', 'max:255'],
            'event_meta.fotografos_almocam_na_quinta' => ['nullable', 'string', 'max:255'],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            $type = $this->input('event_type');
            $status = $this->input('status');
            $meta = $this->input('event_meta', []);
