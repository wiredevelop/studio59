...
class Event extends Model
{
    ...
    private function mergeLegacyMeta(array $meta): array
    {
        ...
        $meta = $this->setMetaIfMissing($meta, 'numero_convidados', $this->guest_count ?? ($meta['Nº CONVIDADOS'] ?? null));
        $meta = $this->setMetaIfMissing(
            $meta,
            'data_entrega',
        ...
        $meta = $this->setMetaIfMissing($meta, 'servico_extras', $meta['Extras'] ?? null);
