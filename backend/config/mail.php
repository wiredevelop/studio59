...
return [
    ...
    */
    ...
    'default' => env('MAIL_MAILER', (bool) env('SMTP_ENABLED', false) ? 'smtp' : 'log'),
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            'transport' => 'smtp',
            'scheme' => env('MAIL_SCHEME', env('SMTP_ENCRYPTION')),
            'url' => env('MAIL_URL'),
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', env('SMTP_FROM_EMAIL', 'hello@example.com')),
