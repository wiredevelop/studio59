...
<main class="max-w-md mx-auto p-6">
    ...
    <div class="bg-white border rounded p-4">
        ...
        <p class="text-sm text-gray-600 mb-4">Introduza a senha para aceder ao catálogo.</p>
        <form method="post" action="{{ route('guest.enter.submit', $event) }}" class="space-y-3">
            @csrf
            <input name="password" type="password" class="w-full border rounded p-2" placeholder="Senha" required autofocus>
