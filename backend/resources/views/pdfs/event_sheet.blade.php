...
<div class="page">
    ...
    <div class="section" style="top: 4mm;">
        ...
        @if(!empty($meta['estar_na_loja_as'] ?? null))
            <div class="sub red">{{ $meta['estar_na_loja_as'] }} no Studio</div>
        @else
    ...
    <div class="section" style="top: 32mm;">
        ...
        <div style="position:absolute; right:0; top:18mm; text-align:right;">
            <div class="val red">{{ $contact1 }}</div>
            <div class="val red">{{ $contact2 }}</div>
        </div>
    </div>
    ...
    <div class="section" style="top: 100mm;">
        <table>
            <tr>
                ...
                <td class="val" style="width:45mm;">{{ $meta['igreja_localidade'] ?? ($meta['igreja_local'] ?? '') }}</td>
